...
function App() {
  ...
  return (
    <div className='min-h-screen flex flex-col'>
      <div className={`relative overflow-hidden before:absolute before:top-0 before:start-1/2 before:bg-[url('./src/assets/polygon-bg-element.svg')] before:bg-no-repeat before:bg-top before:bg-cover before:size-full before:-z-1 before:transform before:-translate-x-1/2`}>
